...
int main(int argc, char* argv[]){
	...
	R2[2] = 1.1;
	//############# end reset #############
	Metropolis(MC_samples, omega, alpha, R1, R2, R1_new, R2_new, R12_new,  W,  local_energy, h,  expectation_energy, 									expectation_energy_squared, MC_rejected_prosent, MC_accepted_prosent, variance,  R12, mean_distance, beta, 							p		otential_energy, mean_potential_energy, kinetic_energy, mean_kinetic_energy);
