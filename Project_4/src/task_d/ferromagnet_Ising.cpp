...
void probability_distribution(double *, int, int);
...
int main(int argc, char* argv[]){
    ...
    sum_absM, sum_absM2;
    int E_max=2*N*N;
    double *E_distribution = new double[E_max];
...
void probability_distribution(double *E_distribution, int E, int E_max){
    /*
