...
int main() {
    ...
    */
    ...
    xv = -1.961253767828543E-06 + 1.35366E-07; //correction for the initial velocity of the Sun
    yv = 6.848684614020077E-06 +  6.54027E-08;
    zv = 3.982709603458882E-08 - 7.21101e-09;
   ...
   /* Initial energy of the Sun computed here. Total momentum of the system should be close to zero.
    double px;
    double py;
    double pz;
    double dx;
    ...
    for(Celestial *celestial : bodies) {
           //cout << px << ',' << py  <<',' << pz << endl;
           px += celestial->v[0]*celestial->mass;
           py += celestial->v[1]*celestial->mass;
           pz += celestial->v[2]*celestial->mass;
    }
    dx = px/365.0;
    dy = py/365.0;
    dz = pz/365.0;
